...
public class DatabaseAccess {
    ...
    public ArrayList<String> getHotelList(String s)
    {
        c=db.rawQuery("select hotelname from hotel where parkname='"+s+"'",new String[]{});
        ArrayList<String> hotels=new ArrayList<String>();
        while(c.moveToNext())
        {
            hotels.add(c.getString(0));
        }
        return hotels;
    }
    ...
    public String getURLHotel(String s)
    {
        c=db.rawQuery("select link from hotel where hotelname='"+s+"'",new String[]{});
        String str=null;
        if(c.moveToFirst())
        {
            str=c.getString(0);
    ...
    public String getHotelDesc(String s)
    {
        c=db.rawQuery("select description from hotel where hotelname='"+s+"'",new String[]{});
        String str=null;
        if(c.moveToFirst())
        {
            str=c.getString(0);
